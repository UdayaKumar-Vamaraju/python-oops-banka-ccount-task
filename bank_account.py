class BankAccount:
    ...
    def __init__(self, account_holder, initial_balance=0, account_type="Current"):
    ...
    def withdraw(self, amount):
        fee = 10  
        min_balance = 1000 if self.account_type == "Savings"
        else 0  
...
class SavingsAccount(BankAccount):
    def __init__(self, account_holder, initial_balance=0):
        super().__init__(account_holder, initial_balance, "Savings")
...
class CurrentAccount(BankAccount):
    def __init__(self, account_holder, initial_balance=0):
        super().__init__(account_holder, initial_balance, "Current")
